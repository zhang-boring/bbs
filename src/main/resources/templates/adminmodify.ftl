        ...
        <div class="col-md-12 column">
            <div class="row clearfix">
                <div class="col-md-6 column">
                    <h5 class="text-right">
                        修改版块：${forum.forumname} (<a href="/admin/list">取消</a>)
                    </h5>
                </div>
                <div class="col-md-6 column">
...
<#--            TODO-->
            <form class="form-horizontal" role="form" action="/admin/execmf" method="post">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">版块名</label>
                    <div class="col-sm-10">
                        <input type="hidden" name="forumid" value="${forum.forumid}">
                        <input type="text" class="form-control" name="forumname" value="${forum.forumname}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">版主用户UID</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="moderator" value="${forum.moderator}" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">描述信息</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="description" value="${forum.description}" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="partid">
                            <#list parts as part>
                                <option value="${part.partid}" <#if part.partid == forum.partid>selected="selected"</#if>>${part.partname}</option>
                            </#list>
                        </select>
                    </div>
                </div>
